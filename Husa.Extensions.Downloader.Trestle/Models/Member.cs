namespace Husa.Extensions.Downloader.Trestle.Models
{
    ...
    public class Member
    {
        ...
        [JsonConverter(typeof(StringListEnumConverter<MemberDesignation>))]
        public IEnumerable<MemberDesignation> MemberDesignation { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<Languages>))]
        public IEnumerable<Languages> MemberLanguages { get; set; }
        ...
        public IEnumerable<Property> ListAgentProperties { get; set; }

        public IEnumerable<Property> CoListAgentProperties { get; set; }

        public IEnumerable<Property> BuyerAgentProperties { get; set; }

        public IEnumerable<Property> CoBuyerAgentProperties { get; set; }
    }
}
