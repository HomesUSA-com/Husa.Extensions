namespace Husa.Extensions.Downloader.Trestle.Models
{
    ...
    public class Property
    {
        ...
        public string AssociationPhone3 { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<ExistingLeaseType>))]
        public IEnumerable<ExistingLeaseType> AvailableLeaseType { get; set; }

        public DateTime? BackOnMarketDate { get; set; }

        public DateTimeOffset? BackOnMarketTimestamp { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<BodyType>))]
        ...
        [JsonConverter(typeof(StringListEnumConverter<BusinessType>))]
        ...
        [JsonConverter(typeof(StringListEnumConverter<BuyerAgentDesignation>))]
        public IEnumerable<BuyerAgentDesignation> BuyerAgentDesignation { get; set; }
        ...
        [JsonConverter(typeof(StringNullableEnumConverter<CompensationType?>))]
        public CompensationType? BuyerBrokerageCompensationType { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<CoBuyerAgentDesignation>))]
        public IEnumerable<CoBuyerAgentDesignation> CoBuyerAgentDesignation { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<CoListAgentDesignation>))]
        public IEnumerable<CoListAgentDesignation> CoListAgentDesignation { get; set; }
        ...
        public int? ConcessionsBuyerBrokerFee { get; set; }

        public int? ConcessionsClosingCosts { get; set; }

        public string ConcessionsComments { get; set; }

        public int? ConcessionsFinancingCosts { get; set; }

        public int? ConcessionsOtherCosts { get; set; }

        public int? ConcessionsPropertyImprovementCosts { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<ExistingLeaseType>))]
        public IEnumerable<ExistingLeaseType> ExistingLeaseType { get; set; }

        public DateTime? ExpirationDate { get; set; }

        [JsonConverter(typeof(StringListEnumConverter<Exposures>))]
        public IEnumerable<Exposures> Exposures { get; set; }
        ...
        [JsonConverter(typeof(StringNullableEnumConverter<FhaEligibility?>))]
        public FhaEligibility? FhaEligibility { get; set; }

        [JsonConverter(typeof(StringListEnumConverter<FinancialDataSource>))]
        public IEnumerable<FinancialDataSource> FinancialDataSource { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<FrontageType>))]
        public IEnumerable<FrontageType> FrontageType { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<GreenBuildingVerificationType>))]
        public IEnumerable<GreenBuildingVerificationType> GreenBuildingVerificationType { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<GreenEnergyGeneration>))]
        public IEnumerable<GreenEnergyGeneration> GreenEnergyGeneration { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<GreenLocation>))]
        public IEnumerable<GreenLocation> GreenLocation { get; set; }

        [JsonConverter(typeof(StringListEnumConverter<GreenSustainability>))]
        public IEnumerable<GreenSustainability> GreenSustainability { get; set; }
        ...
        public string HeadBrokerMemberKey { get; set; }

        public string HeadBrokerMemberMlsId { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<HoursDaysOfOperation>))]
        public IEnumerable<HoursDaysOfOperation> HoursDaysOfOperation { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<IrrigationSource>))]
        public IEnumerable<IrrigationSource> IrrigationSource { get; set; }

        public decimal? IrrigationWaterRightsAcres { get; set; }

        public bool? IrrigationWaterRightsYN { get; set; }

        [JsonConverter(typeof(StringListEnumConverter<LaborInformation>))]
        public IEnumerable<LaborInformation> LaborInformation { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<LeaseTerm>))]
        public IEnumerable<LeaseTerm> LeaseTermOptions { get; set; }

        [JsonConverter(typeof(StringListEnumConverter<Levels>))]
        public IEnumerable<Levels> Levels { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<ListAgentDesignation>))]
        public IEnumerable<ListAgentDesignation> ListAgentDesignation { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<LockBoxType>))]
        public IEnumerable<LockBoxType> LockBoxType { get; set; }
        ...
        public int? MaximumNumberOfPets { get; set; }

        public int? MaximumPetWeight { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<OperatingExpenseIncludes>))]
        public IEnumerable<OperatingExpenseIncludes> OperatingExpenseIncludes { get; set; }
        ...
        public string ParcelSubcomponent { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<PetsAllowed>))]
        public IEnumerable<PetsAllowed> PetsAllowed { get; set; }

        public bool? PetsAllowedYN { get; set; }

        public string PetsComments { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<RoadResponsibility>))]
        public IEnumerable<RoadResponsibility> RoadResponsibility { get; set; }

        [JsonConverter(typeof(StringListEnumConverter<RoadSurfaceType>))]
        public IEnumerable<RoadSurfaceType> RoadSurfaceType { get; set; }
        ...
        public bool? SellerConsiderConcessionYN { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<ShowingConsiderations>))]
        public IEnumerable<ShowingConsiderations> ShowingConsiderations { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<ShowingContactType>))]
        public IEnumerable<ShowingContactType> ShowingContactType { get; set; }

        [JsonConverter(typeof(StringListEnumConverter<ShowingDays>))]
        public IEnumerable<ShowingDays> ShowingDays { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<StructureType>))]
        public IEnumerable<StructureType> StructureType { get; set; }
        ...
        [JsonConverter(typeof(StringListEnumConverter<TaxStatusCurrent>))]
        public IEnumerable<TaxStatusCurrent> TaxStatusCurrent { get; set; }

        public string TaxTract { get; set; }

        public int? TaxYear { get; set; }

        [JsonConverter(typeof(StringListEnumConverter<TenantPays>))]
        public IEnumerable<TenantPays> TenantPays { get; set; }
        ...
        [JsonConverter(typeof(StringNullableEnumConverter<YearBuiltSource?>))]
        ...
        public IEnumerable<Member> BuyerAgent { get; set; }

        public IEnumerable<Member> CoBuyerAgent { get; set; }

        public IEnumerable<Member> CoListAgent { get; set; }

        public IEnumerable<Member> ListAgent { get; set; }

        public IEnumerable<Office> BuyerOffice { get; set; }

        public IEnumerable<Office> CoBuyerOffice { get; set; }

        public IEnumerable<Office> CoListOffice { get; set; }

        public IEnumerable<Office> ListOffice { get; set; }

        public IEnumerable<CustomProperty> CustomProperty { get; set; }

        public IEnumerable<PropertyRooms> Rooms { get; set; }

        public IEnumerable<PropertyUnitTypes> UnitTypes { get; set; }
    }
}
